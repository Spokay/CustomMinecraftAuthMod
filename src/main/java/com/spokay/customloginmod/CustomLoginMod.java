...
@Mod(CustomLoginMod.MODID)
public class CustomLoginMod
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "customloginmod";
    ...
    public CustomLoginMod()
    {
        ...
        /*LoginScreenEventSubscriber clientLaunchCompleteEventSubscriber = new LoginScreenEventSubscriber();

        MinecraftForge.EVENT_BUS.register(LoginScreenEventSubscriber.class);*/
